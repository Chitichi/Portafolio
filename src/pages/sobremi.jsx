        ...
        <div className="row">
          <div className=" text-center text-white  col-md-6 col-sm-12 ">
            ...
            <div className="text-center text-white ">
              <h4>
                Soy desarrolladora web apasionada y proactiva, especializada en
                la creación de soluciones innovadoras y funcionales. En
                constante búsqueda de desafíos y aprendizaje, valoro el trabajo
                en equipo y la colaboración para lograr resultados
                excepcionales. Mi portfolio refleja mi enfoque creativo y
                resolutivo, y demuestra mi capacidad para implementar proyectos
                exitosos. Si buscas una desarrolladora web entusiasta y
